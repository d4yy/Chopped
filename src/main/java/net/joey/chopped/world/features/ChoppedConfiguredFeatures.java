...
import net.joey.chopped.world.features.trees.types.ChoppedTreeFeature;
import net.joey.chopped.world.features.trees.types.DroopingTreeFeature;
import net.joey.chopped.world.features.trees.types.ShrubTreeFeature;
...
public class ChoppedConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> APPLE_TREE_RED = registerKey("apple_tree_red");
    public static final ResourceKey<ConfiguredFeature<?, ?>> APPLE_TREE_GREEN = registerKey("apple_tree_green");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, HIMALAYAN_SALT_ORE, Feature.ORE, new OreConfiguration(FeatureTargetRules.OreReplaceTargets.ORE_HIMALAYAN_SALT_TARGET_LIST.get(), 16, 0.0F));
        ...
        register(context, APPLE_TREE_RED, DROOPING_TREE_BASE, new DroopingTreeConfiguration.Builder().trunk(BlockStateProvider.simple(ChoppedBlocks.BLOCKS_APPLEWOOD_LOG.get())).foliage(BlockStateProvider.simple(ChoppedBlocks.BLOCKS_APPLE_LEAVES.get().defaultBlockState().setValue(FruitBearingLeavesBlock.CULTIVAR, 0))).build());
        register(context, APPLE_TREE_GREEN, DROOPING_TREE_BASE, new DroopingTreeConfiguration.Builder().trunk(BlockStateProvider.simple(ChoppedBlocks.BLOCKS_APPLEWOOD_LOG.get())).foliage(BlockStateProvider.simple(ChoppedBlocks.BLOCKS_APPLE_LEAVES.get().defaultBlockState().setValue(FruitBearingLeavesBlock.CULTIVAR, 1))).build());
