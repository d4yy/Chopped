...
public class ChoppedTreeConfiguration extends TreeConfiguration {
    public static final Codec<ChoppedTreeConfiguration> CODEC = RecordCodecBuilder.create((builder) -> {
        ...
        ).apply(builder, ChoppedTreeConfiguration::new);
    });
    ...
    public static class Builder<T extends Builder> {
        ...
        public ChoppedTreeConfiguration build() {
            return new ChoppedTreeConfiguration(this.trunkProvider, this.foliageProvider, this.vineProvider, this.hangingProvider, this.trunkFruitProvider, this.altFoliageProvider, this.minHeight, this.maxHeight, this.decorators);
        }
    }
}
